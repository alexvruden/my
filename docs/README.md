...
<br>
5. Для обновления скрипта скачать архив и перезаписать все файлы. Обновление не затрагивает пользовательские изменения.
<br>
<br>
Если вы вносили изменения в языковые файлы (в папке <code>\lang</code>), то нужно их сравнить с файлом в обновлении, иначе вы можете потерять свои исправления/дополнения при перезаписи файлов.
<br>
<br>
