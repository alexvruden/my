...
<br>
<br>
Скачать <a href="https://github.com/alexvruden/my/releases/download/BC/BC.zip" title="https://github.com/alexvruden/my/releases/download/BC/BC.zip">скрипт</a>.
<br>
<br>
В релизе только скрипты и текстовые файлы, драйверы вы загружаете самостоятельно из репозитория разработчика (<b>bol-van</b>).
<br>
В релизе нет списков <i>доменов</i> и <i>ip-адресов</i>, вы загружаете самостоятельно их из любого доступного источника.
<br>
<br>
Для обновления скрипта скачать архив и перезаписать все файлы. Обновление не затрагивает пользовательские изменения.
<br>
Если вы вносили изменения в языковые файлы, то нужно их сравнить с файлом в обновлении, иначе вы можете потерять свои исправления/дополнения при перезаписи файлов.
<br>
<br>
...
<br>
<br>
Посмотреть видео работы скрипта.
<br>
<br>

https://github.com/user-attachments/assets/d0bb33ea-3b8e-4eb6-b42e-88a79d5f29d9
