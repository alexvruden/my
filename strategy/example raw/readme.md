...
<br>
Нельзя создать два процесса стратегии с фильтром <code>--wf-tcp</code> ( <code>--wf-udp</code> ) на одном порте, поэтому применим <code>--wf-raw</code>  и 'iptables' в 'windivert'.
<br>
Используя <code>--wf-raw</code> мы можем в ядре 'windivert' на одном порте, но в разных процессах отсеивать трафик.
<br>
<br>
Strategy 1 ------------------------------------------------------------------------------<br>
<br>
...
<br>
<br>
После запуска будет создано два процесса 'winws' со своими профилями на одном порту 443.
<br>
<br>
