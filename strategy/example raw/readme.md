...
<br>
Размер фильтра не должен превышать 16 кбайт, поэтому для уменьшения размера нужно после редактирования убрать лишние символы (пробелы, табуляция, символы конца строк).
<br>
