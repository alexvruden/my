...
<br>
<br>
Если в качестве параметра указать RND, то скрипт РАНДОМНО сгенерирует hex-строку рукопожатия.
<br>
Например:
<br>
<code>--dpi-desync-fakedsplit-pattern=RND</code> - сгенерирует строку рукопожатия
<br>
<code>--dpi-desync-fakedsplit-pattern=0x160303<длина><ClientHello></code> - сгенерирует строку рукопожатия
<br>
<br>
