...
Если строка начинается с символа $, то скрипт обработает ее и добавит к описанию ПРОФИЛЯ стратегии, не путать с 'about'.<br>
Если символ $ для описания профиля отсутствует, то описание будет создано из имени 'windivert' фильтра <br>
<br>
'WINDIVERT FILTER':<br>
<br>
