...
<br>
<br>
Если в качестве параметра указать HEX:1300, то скрипт РАНДОМНО сгенерирует hex-строку из 1300 байт в заданном параметре.
<br>
Например:
<br>
<code>--dpi-desync-fakedsplit-pattern=HEX:500</code> - сгенерирует строку из 500 байт
<br>
<code>--dpi-desync-fakedsplit-pattern=0xA158D4C7F7159E53D710....</code>
<br>
<br>
